...
BattleDialogueUI::BattleDialogueUI()
{
	...
	cocos2d::Size dSize(1136, 640);

	m_battleDialogueUI = cocos2d::CSLoader::getInstance()->createNode("Scene/DialoguePopup.csb");
	m_battleDialogueUI->setContentSize(frameSize);
	
	cocos2d::ui::Helper::doLayout(m_battleDialogueUI);
...
void BattleDialogueUI::showCurrent()
{
	...
	m_dialogueTimeline = cocos2d::CSLoader::getInstance()->createTimeline("Scene/DialoguePopup.csb");
