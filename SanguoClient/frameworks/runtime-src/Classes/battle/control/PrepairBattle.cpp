...
void PrepairBattle::update(float dt)
{
    switch(m_currentStep)
    {
        ...
        if(m_currentAsset < m_assetSoldiers.size())
        {
            ...
            AssetDefineCache::getInstance()->addAssetWithFile(m_pathSolder + asset + ".png", m_pathSolder + asset + ".dat", asset);
        ...
        if(m_currentAsset < m_assetHeros.size())
        {
            ...
            AssetDefineCache::getInstance()->addAssetWithFile(m_pathHero + asset + ".png", m_pathHero + asset + ".dat", asset);
        ...
        if(m_currentAsset < m_assetSkills.size())
        {
            ...
            AssetDefineCache::getInstance()->addAssetWithFile(m_pathSkill + asset + ".png", m_pathSkill + asset + ".dat", asset);
        ...
        case 3:
        AssetDefineCache::getInstance()->addAssetWithFile("png/effect/battleEffect.png", "png/effect/battleEffect.dat", "battleEffect");
        _ENTITY_EVENT.emit<BattleEvent::StartBattleProgress>(57);
        m_currentStep++;
        break;
        
        case 4:
        AssetDefineCache::getInstance()->addAssetWithFile("png/effect/attack.png", "png/effect/attack.dat", "attack");
        _ENTITY_EVENT.emit<BattleEvent::StartBattleProgress>(59);
        m_currentStep++;
        break;
        
        case 5:
        AssetDefineCache::getInstance()->addAssetWithFile("png/effect/damage.png", "png/effect/damage.dat", "damage");
        _ENTITY_EVENT.emit<BattleEvent::StartBattleProgress>(61);
        m_currentStep++;
        break;
        
        case 6:
        AssetDefineCache::getInstance()->addAssetWithFile("png/bg/decoration1.png", "png/bg/decoration1.dat", "scene_decoration1");
        _ENTITY_EVENT.emit<BattleEvent::StartBattleProgress>(63);
        m_currentStep++;
        break;
        
        case 7:
        AssetDefineCache::getInstance()->addAssetWithFile("png/bg/decoration2.png", "png/bg/decoration2.dat", "scene_decoration2");
        _ENTITY_EVENT.emit<BattleEvent::StartBattleProgress>(65);
        m_currentStep++;
        break;
        
        case 8:
        AssetDefineCache::getInstance()->addAssetWithFile("png/bg/closeup.png", "png/bg/closeup.dat", "scene_closeup");
